...
<div class="container-xxl py-5">
    <div class="container">
        <div class="text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-3">Dashboard Coach</h1>
            <p class="mb-4">Selamat datang di Dashboard Coach MFP Academy, {{ Auth::user()->name }}!</p>
        </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        ...
                        <p class="mb-0">Kelola daftar peserta, lihat kemajuan, dan buat catatan perkembangan.</p>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        ...
                        <p class="mb-0">Lihat dan atur jadwal latihan yang akan datang.</p>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        ...
                        <h5 class="mb-3">Program Latihan</h5>
                        <p class="mb-0">Buat dan kelola program latihan untuk berbagai kelompok usia.</p>
                        <a href="#" class="btn btn-sm btn-primary rounded-pill mt-3 disabled">Segera Hadir</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                <div class="service-item position-relative h-100">
                    <div class="service-text rounded p-5">
                        ...
                        <p class="mb-0">Lihat pengumuman penting dari MFP Academy.</p>
