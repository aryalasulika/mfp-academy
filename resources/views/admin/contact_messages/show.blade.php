                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl py-4">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                <h4 class="mb-3">{{ $message->subjek }}</h4>
                                <p><strong>Nama:</strong> {{ $message->nama }}</p>
                                <p><strong>Email:</strong> {{ $message->email }}</p>
                                <p><strong>Tanggal:</strong> {{ $message->created_at->format('d-m-Y H:i') }}</p>
                                <hr>
                                <p><strong>Pesan:</strong></p>
                                <div class="bg-light p-3 rounded">{{ $message->pesan }}</div>
                            </div>
                        </div>
                        <div class="d-flex justify-content-end">
                            <a href="{{ route('admin.contact_messages.index') }}" class="btn btn-secondary mt-3">&larr;
                                Kembali
                                ke Daftar Pesan</a>
                        </div>
                    </div>
