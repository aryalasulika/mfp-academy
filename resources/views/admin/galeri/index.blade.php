                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl py-4">
                        <div class="d-flex justify-content-between align-items-center mb-3">
                            <h2>Daftar Galeri</h2>
                            <a href="{{ route('admin.galeri.create') }}" class="btn btn-primary">Tambah Media</a>
                        </div>
                        @if (session('success'))
                        ...
                        <div class="row g-4">
                                ...
                                <div class="col-6 col-md-4 col-lg-3">
                                    <div class="card border-0 shadow-sm h-100 galeri-card">
                                        @if (Str::startsWith($item->tipe, 'image'))
                                            <img src="{{ asset('storage/' . $item->file) }}" class="card-img-top img-fluid"
                                                alt="{{ $item->judul }}">
                                        ...
                                        <div class="card-body p-2">
                                            <div class="fw-bold small text-primary mb-1">{{ $item->judul }}</div>
                                        ...
                                        <div class="card-footer bg-white border-0 text-end py-2">
                                            ...
                                            <form action="{{ route('admin.galeri.destroy', $item->id) }}" method="POST"
                                                class="d-inline" onsubmit="return confirm('Yakin hapus media ini?')">
                                                @csrf
                                                @method('DELETE')
                            ...
                            @empty
                                <div class="col-12 text-center">
                                    <div class="alert alert-info">Belum ada media galeri.</div>
                                </div>
                            @endforelse
                        </div>
                        <div class="mt-3">
