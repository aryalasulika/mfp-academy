            ...
            <div class="layout-page">
                ...
                <nav class="layout-navbar container-xxl navbar navbar-expand-xl navbar-detached align-items-center bg-navbar-theme shadow-sm rounded-3 mt-3 mb-4 px-4 py-2"
                    ...
                    <div class="navbar-nav-right d-flex align-items-center w-100" id="navbar-collapse">
                        <span class="fw-bold text-primary fs-4 ms-2">Edit Merchandise</span>
                    ...
                    <div class="container-xxl py-4">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <h4 class="card-title mb-0">Form Edit Merchandise</h4>
                            </div>
                        </div>
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" 
                                              ...
                                              placeholder="Masukkan deskripsi produk">{{ old('description', $merchandise->description) }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select @error('category') is-invalid @enderror" 
                                                ...
                                                @foreach($categories as $key => $value)
                                                    <option value="{{ $key }}" 
                                                            {{ old('category', $merchandise->category) == $key ? 'selected' : '' }}>
                                                        {{ $value }}
                                                    </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="border rounded p-2 text-center" style="min-height: 200px;">
                                        @if($merchandise->image)
                                            <img id="image-preview" src="{{ asset($merchandise->image) }}" alt="Preview" 
                                                 style="max-width: 100%; max-height: 200px;" class="rounded">
                                            <div id="no-image" class="d-flex align-items-center justify-content-center h-100" style="display: none !important;">
                                        ...
                                        @else
                                            <img id="image-preview" src="#" alt="Preview" 
                                                 style="max-width: 100%; max-height: 200px; display: none;" class="rounded">
...
function previewImage(event) {
    ...
    if (file) {
        ...
        // Jika file dihapus, kembali ke gambar asli atau no image
        @if($merchandise->image)
            preview.src = "{{ asset($merchandise->image) }}";
            preview.style.display = 'block';
            noImage.style.display = 'none';
        @else
